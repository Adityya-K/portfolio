...
<div class="flex w-screen justify-center" onmousemove={handleMousemove} role="region">
	<div class="grid w-full max-w-[1200px] pt-32 lg:grid-cols-7">
		<div
			class="w-full self-start px-4 pr-16 text-blue-100 lg:sticky lg:top-32 lg:col-span-3 lg:px-0"
		>
			...
			<div class="py-10">
				<ul>
					...
					<a href="#schooling">
						<li
							class={y >= 1 && y < 400 ? 'text-xl font-extrabold transition-all' : 'transition-all'}
						>
		...
		<div class="w-full lg:col-span-4">
			<div class="px-4 pb-4 text-lg leading-loose text-blue-200 opacity-50" id="about">
				<p>
