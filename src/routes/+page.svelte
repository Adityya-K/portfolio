...
<div class="flex w-screen justify-center" onmousemove={handleMousemove} role="region">
	<div class="grid w-full max-w-[1200px] pt-32 lg:grid-cols-2">
		<div class="sticky top-32 w-full self-start pr-16 text-blue-100">
